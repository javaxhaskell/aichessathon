...
export default async function OpenGraphImage() {
  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", position: "relative", overflow: "hidden", background: "#06080b", color: "#f3f6fa", padding: "64px 72px", fontFamily: "sans-serif" }}>
      ...
      <div style={{ position: "absolute", right: 65, top: 67, width: 440, height: 440, display: "flex", border: "1px solid #899180", borderRadius: 12, overflow: "hidden", transform: "rotate(3deg)", boxShadow: "0 30px 90px #000" }}>
        <img src={boardSrc} width={440} height={440} alt="" />
      </div>
